...
function Server(compiler, options) {
	...
	// middleware for serving webpacker bundle
	...
	app.get("/webpacker-dev-server.js", function(req, res) {
		res.setHeader("Content-Type", "application/javascript");
		inlinedJs.pipe(res);
	});

	app.get("/webpacker-dev-server/*", function(req, res) {
			...
			content.forEach(function(item) {
				...
				if(fs.statSync(p).isFile()) {
					...
					if(/\.js$/.test(item)) {
						...
						res.write('">webpacker-dev-server</a>)</li>');
					}
				} else {
					res.write('<li>');
					res.write(item);
