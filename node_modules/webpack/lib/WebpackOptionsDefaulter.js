...
WebpackOptionsDefaulter.prototype.process = function(options) {
	...
	options.resolve.extensions = defaultByTarget(options.resolve.extensions, ["", ".webpack.js", ".web.js", ".js", ".json"], ["", ".webpacker-worker.js", ".webworker.js", ".web.js", ".js", ".json"], ["", ".webpacker-node.js", ".js", ".json", ".node"], ["", ".webpacker-node-webkit.js", ".webpacker-node.js", ".js", ".json", ".node", ".web.js"], ["", ".js", ".json"]);

	options.resolveLoader.extensions = defaultByTarget(options.resolveLoader.extensions, ["", ".webpacker-loader.js", ".web-loader.js", ".loader.js", ".js"], ["", ".webpacker-worker-loader.js", ".webpacker-loader.js", ".webworker-loader.js", ".web-loader.js", ".loader.js", ".js"], ["", ".webpacker-node-loader.js", ".loader.js", ".js"], ["", ".webpacker-node-webkit-loader.js", ".webpacker-node-loader.js", ".loader.js", ".web-loader.js", ".js"], ["", ".js"]);

	options.resolveLoader.moduleTemplates = defaultByTarget(options.resolveLoader.moduleTemplates, ["*-webpacker-loader", "*-web-loader", "*-loader", "*"], ["*-webpacker-worker-loader", "*-webworker-loader", "*-web-loader", "*-loader", "*"], ["*-webpacker-node-loader", "*-node-loader", "*-loader", "*"], ["*-webpacker-node-webkit-loader", "*-webpacker-node-loader", "*-node-loader", "*-loader", "*-web-loader", "*"], ["*-loader", "*"]);
};
