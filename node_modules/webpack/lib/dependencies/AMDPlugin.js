...
AMDPlugin.prototype.apply = function(compiler) {
	...
	setExpressionToModule("require.amd", "!!webpacker amd options");
	setExpressionToModule("define.amd", "!!webpacker amd options");
	setExpressionToModule("define", "!!webpacker amd define");
	...
	compiler.parser.plugin("rename define", function(expr) {
		var dep = new AMDRequireItemDependency("!!webpacker amd define", expr.range);
